...
int main(void)
{
	...
	uint16_t EK[16] = {0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF};

	uint16_t QK[16] = {0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF};

	uint16_t OR[16] = {0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF,0x0123, 0x4567, 0x89AB, 0xCDEF};
